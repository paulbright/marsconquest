...
public class Rover implements IVehicle {
    ...
    private static Image img_n = ImageHandler.loadImage(Rover.class.getResource("/images/rover_n.png"));
    private static Image img_s = ImageHandler.loadImage(Rover.class.getResource("/images/rover_s.png"));
    private static Image img_e = ImageHandler.loadImage(Rover.class.getResource("/images/rover_e.png"));
    private static Image img_w = ImageHandler.loadImage(Rover.class.getResource("/images/rover_w.png"));
